...
static void PrintUsage(void)
{
	...
	printf("Example: %s -hlocalhost -p34000 -I0X00124B0001142FD0 -S0 -T0\n", file), exit(1);
}
...
int main(int argc, char *argv[])
{
	...
	while ((c = getopt(argc, argv, "h:p:T:I:S:")) != -1)
	{
		switch (c)
		{
		default:
	...
	printf("ZdoNwkAddrReq (0X0025): [TYPE]=%d [START_INDEX]=%d [IA]=0X%016"PRIX64" \n", type, start, ia);
