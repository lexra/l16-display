...
void PrintUsage(void)
{
	...
	printf("Usage: %s -h [host] -p [connect port] -a [Short Address] -r [Radius] -o [Tx Options] -E [ENABLE]\n", file);
	printf("Example: %s -hlocalhost -p34000 -a0X796F -r30 -o0X20 -E1\n", file), exit(1);
}
...
//
	...
	printf("L16_HYBERNATE_ENABLE (0X0124,0X00E6): [SA]=0X%04X [RADIUS]=0X%02X,%03u [TXOPTS]=0X%02X [ENABLE]=%02u\n", addr, radius, radius, txopts, enable);
